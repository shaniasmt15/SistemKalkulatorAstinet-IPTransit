...
@section('title', 'astinetbb')

@section('beranda-nav', '')
@section('astinetlite-nav', '')
@section('astinetbb-nav', 'active')
								...
								<form id="form_astinet">
								    <section class="hk-sec-wrapper pb-10 pt-0 mb-0" style=" border-radius: 5px">
								        <div class="pt-10 pb-30">	
    								    	<h3 class="display-4 text-center">Kalkulator Astinet BB</h3>
                       					...
                       					<div class="row mt-15">
                           					...
                           					<div class="col-5 pr-10">
												<input id="input_bw_global" name="input_bw_global" class="form-control" type="number" min="1" max="1000" placeholder="0" required>
											</div>
										...
										<div class="row mt-15">
                           					...
                           					<div class="col-5 pr-10">
												<input id="input_bw_domestik" name="input_bw_domestik" class="form-control" type="number" min="1" max="1000" placeholder="0" required>
											</div>
											<div class="col-1 mt-10 pl-0">
												<label>Mbps</label>
											</div>
...
@section('javascript')
	...
	<script type="text/javascript">
		...
		$("#form_astinet_bb").submit(function(e){
			...
			var formData = new FormData($('#form_astinet_bb')[0]);
			...
			$.ajax({
				...
				success: function(data){   
				  	...
				  	$("#total_tarif_bb").html(data['total_astinet_bb']);
				}
			});
